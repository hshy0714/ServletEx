...
public class LifecycleServlet extends HttpServlet {
	...
	@Override
	public void init() throws ServletException {	//	순서는 init -> service -> doGet or doPost -> destroy
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		//	요청이 들어올 때 호출, 요청 방식에 따라 doGet or doPost가 호출
...
//		resp.setContentType("text/html;charset=UTF-8");
		...
		out.println("<ul>");								//	순서 없는 리스트
		out.println("<li>dburl:" + dburl + "</li>");		//	li는 list item이란 뜻
